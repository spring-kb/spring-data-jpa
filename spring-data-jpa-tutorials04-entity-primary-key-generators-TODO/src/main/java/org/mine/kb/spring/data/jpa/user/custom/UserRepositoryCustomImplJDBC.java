 ...
 * this case. For basic programmatic setup see
 ...
 * bean injected for custom repository
...
public class UserRepositoryCustomImplJDBC extends JdbcDaoSupport implements UserRepositoryCustom {

    private static final String COMPLICATED_SQL = "SELECT * FROM User";

    @Autowired
    public UserRepositoryCustomImplJDBC(DataSource dataSource) {
